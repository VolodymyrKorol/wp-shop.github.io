				...
				<div id="col-left">
					<div class="col-wrap">
						<div class="form-wrap">
							...
							<p><?php esc_html_e( 'Attributes let you define extra product data, such as size or color. You can use these attributes in the shop sidebars using the "layered nav" widgets.', 'woocommerce' ); ?></p>
